...
export default function Layout() {
  return (
    <div className="flex w-screen ">
      <nav className=" w-[12.5%] h-screen">
        <div className="flex justify-center m-[60px] ">
          <img
            src="./logo.jpg"
            alt="logo"
            className="w-[100px] h-[100px] border-4 border-red-300 rounded-full"
          />
        </div>
        <div className="flex font-bold text-[30px] justify-start items-center">
          <svg
