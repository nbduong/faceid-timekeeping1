...
export const Login = () => {
    ...
    return (
        <form action="#" method="post" className="w-[560px] h-[600px] bg-[#E7E8EA] shadow-2xl flex items-center flex-col rounded-2xl">
            <div className="flex justify-center mt-12">
                <img className="w-[150px] h-[150px] rounded-full" src="/logo.jpg" alt="" />
            </div>
            ...
            <div className="flex justify-center mt-6">
                <button type="submit" className="shadow-md shadow-slate-500 w-[200px] h-[50px] bg-indigo-500 text-white font-bold rounded-sm hover:bg-indigo-400 transition duration-300 ease-in-out">
                    Đăng nhập
                </button>
            </div>
        </form>
